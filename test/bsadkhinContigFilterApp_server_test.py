...
from bsadkhinContigFilterApp.bsadkhinContigFilterAppImpl import bsadkhinContigFilterApp
from bsadkhinContigFilterApp.bsadkhinContigFilterAppServer import MethodContext
from bsadkhinContigFilterApp.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class bsadkhinContigFilterAppTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('bsadkhinContigFilterApp'):
        ...
        cls.ctx.update({'token': token,
                        'user_id': user_id,
                        'provenance': [
                            {'service': 'bsadkhinContigFilterApp',
        ...
        cls.serviceImpl = bsadkhinContigFilterApp(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_bsadkhinContigFilterApp_" + str(suffix)
